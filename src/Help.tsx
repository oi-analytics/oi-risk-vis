...
const HazardHelp = () => (
  <div className="custom-map-control top-right selected-feature">
    ...
    <p>
      The flood (fluvial and coastal) maps show 1/100-year return period flood
      outlines at 30 arc second grid squares.
    </p>

    <p>
      The cyclone map shows 1/100-year return period wind speeds at in m/s at
      0.1-degree grid squares.
    </p>

    <p>
      These are one of several maps used in this study the details of which are
      described below.
    </p>
    ...
    <table className="table table-sm">
      ...
      <tbody>
        <tr>
          <td>
            ...
            <a
              ...
              href="https://www.wri.org/data/aqueduct-floods-hazard-maps"
            >
              WRI Aqueduct
            </a>
          </td>
          <td rowSpan={2}>
            1/2, 1/5, 1/10, 1/25, 1/50, 1/100, 1/250, 1/500, and 1/1000{" "}
          </td>
          <td rowSpan={2}>
            Flood depths in meters over 30 arc second grid squares.{" "}
          </td>
          <td rowSpan={2}>
            <ul>
        ...
        <tr>
          ...
          <td>
            3-hour time step wind gust speeds in m/s at 0.1-degree grid squares.
          </td>
          <td>None</td>
        </tr>
      </tbody>
